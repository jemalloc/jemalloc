...
static const ctl_named_node_t stats_arenas_i_node[] = {
	...
	{NAME("metadata_thp"),	CTL(stats_arenas_i_metadata_edata)},
	{NAME("metadata_thp"),	CTL(stats_arenas_i_metadata_rtree)},
...
CTL_RO_CGEN(config_stats, stats_metadata_edata, ctl_stats->metadata_edata, size_t)
CTL_RO_CGEN(config_stats, stats_metadata_rtree, ctl_stats->metadata_rtree, size_t)
...
CTL_RO_CGEN(config_stats, stats_arenas_i_metadata_edata,
    arenas_i(mib[2])->astats->astats.metadata_edata,
    size_t)
CTL_RO_CGEN(config_stats, stats_arenas_i_metadata_rtree,
    arenas_i(mib[2])->astats->astats.metadata_rtree,
    size_t)
