...
sz_psz2ind(size_t psz) {
	...
	/*
	 * sc.h introduces a lot of size classes. These size classes
	 * are divided into different size class groups.
	 * There is a very special size class group,
	 * each size class in or after it is an integer multiple of PAGE.
	 * We call it first_ps_rg. It means first page size regular group.
	 * The range of first_ps_rg is (base, base * 2],
	 * and base == PAGE * SC_NGROUP.
	 * off_to_first_ps_rg is begin from 1, instead of 0.
	 * e.g. off_to_first_ps_rg is 1 when psz is (PAGE * SC_NGROUP + 1).
	 */
	 ...
	 * ndelta is offset to the first size class in the size class group, starts from 1.
	 * If you don't know lg_base, ndelta or lg_delta, see sc.h for more infos.
