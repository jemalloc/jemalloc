...
TEST_BEGIN(test_arena_i_name) {
    ...
    expect_d_eq(mallctl("arenas.create", (void *)&arena_ind, &ind_sz, NULL, 0),
      0, "Unexpected mallctl() failure");
    mib[1] = arena_ind;

    malloc_snprintf(default_name, sizeof(default_name), "manual_%u", arena_ind);
    ...
    expect_d_eq(mallctlbymib(mib, miblen, (void *)&name_oldp, &sz, NULL, 0), 0,
      "Unexpected mallctl() failure");
