...
set_prof_active(bool active) {
    expect_d_eq(
      mallctl("prof.active", NULL, NULL, (void *)&active, sizeof(active)), 0,
...
do_prof_reset(size_t lg_prof_sample_input) {
    expect_d_eq(mallctl("prof.reset", NULL, NULL, (void *)&lg_prof_sample_input,
                  sizeof(size_t)),
...
TEST_BEGIN(test_prof_reset_basic) {
    ...
    sz = sizeof(size_t);
    expect_d_eq(
      mallctl("opt.lg_prof_sample", (void *)&lg_prof_sample_orig, &sz, NULL, 0),
...
thd_start(void *varg) {
    ...
    for (i = 0; i < NALLOCS_PER_THREAD; i++) {
        ...
        if (i % DUMP_INTERVAL == 0) {
            expect_d_eq(mallctl("prof.dump", NULL, NULL, NULL, 0), 0,
...
TEST_BEGIN(test_prof_reset) {
    ...
    expect_zu_eq(
      prof_tdata_count(), tdata_count, "Unexpected remaining tdata structures");
